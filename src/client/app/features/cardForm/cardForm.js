rootApp.controller("cardForm", function($scope, cardNames, abilityNames, attackNames) {
    
    $scope.cards = cardNames.cards;
    $scope.attacks = attackNames;
    $scope.abilities = abilityNames;
    $scope.properties = [];
